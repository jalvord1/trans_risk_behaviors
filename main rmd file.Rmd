...
```{r}
filtered_data<-filtered_data %>%
  mutate(state_factor = factor(x.state, levels=c(6, 9, 10, 13, 15, 16, 17, 18, 19, 21, 22, 25, 27, 28, 29, 32, 36, 39, 42, 44, 48, 50, 51, 53, 55, 66), labels=c("California", "Connecticut", "Delaware", "Georgia", "Hawaii", "Idaho", "Illinois", "Indiana", "Iowa", "Kentucky", "Louisiana", "Massachusetts", "Minnesota", "Mississippi", "Missouri", "Nevada", "New York", "Ohio", "Pennsylvania", "Rhode Island", "Texas", "Vermont", "Virginia", "Washington", "Wisconsin", "Guam"))) %>%
  mutate(genhlth_factor = factor(genhlth, levels=c(1, 2, 3, 4, 5, 7, 9), labels=c("Excellent", "Very good", "Good", "Fair", "Poor", "Don't know/Not Sure", "Refused")))
