...
This study will use data from the Behavioral Risk Factor Surveillance System (BRFSS). We will be using the survey data taken in 2016. The This is the most recent year, so the information will be the most up-to-date. BRFSS is a telephone survey that collects data from US residents on health risks, chronic illnesses, and access to health services.
