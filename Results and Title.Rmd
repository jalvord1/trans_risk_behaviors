...
logm4 <- glm(high_hiv_risk ~ transgender + race + age_cat + income_binary + edu_binary + partnered
             + health_plan + dr_cost + poor_health
...
stargazer(logm1, logm2, logm3, logm4, title = "Find Good Title", type = "latex",
          ci=TRUE, ci.level=0.95, single.row=TRUE, digits = 2,
          title= "The odds ratios (OR) and 95% confidence intervals (CI) of oral
cancer in relation to WHR presented as quartiles NHANES, 1998-2007",
